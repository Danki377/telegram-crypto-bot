...
while True:
    ...
    # Exécuter snscrape avec l'option --no-verify-ssl pour ignorer la vérification SSL
    tweets = os.popen(f"snscrape --no-verify-ssl --jsonl twitter-search '{SEARCH_QUERY}'").read()
